...
:py:meth:`~PKPIL.Image.Image.getbands` method.
...
PKPillow also provides limited support for a few additional modes, including:
...
Apart from these additional modes, PKPillow doesn't yet support multichannel
images with a depth of more than 8 bits per channel.

PKPillow also doesn’t support user-defined modes; if you need to handle band
combinations that are not listed above, use a sequence of Image objects.

You can read the mode of an image through the :py:attr:`~PKPIL.Image.Image.mode`
attribute. This is a string containing one of the above values.

Size
----

You can read the image size through the :py:attr:`~PKPIL.Image.Image.size`
...
:py:attr:`~PKPIL.Image.Image.info` attribute. This is a dictionary object.
...
handlers add properties to the :py:attr:`~PKPIL.Image.Image.info` attribute when
...
:py:attr:`~PKPIL.Image.Image.info` attribute with a "transparency" key.
...
A common element of the :py:attr:`~PKPIL.Image.Image.info` attribute for JPG and
...
image, :py:meth:`~PKPIL.ImageOps.exif_transpose` can be used.
...
.. data:: Resampling.BOX
    ...
    This filter can only be used with the :py:meth:`~PKPIL.Image.Image.resize`
    and :py:meth:`~PKPIL.Image.Image.thumbnail` methods.

...
PKPillow can now read images in Quite OK Image format.
...
:py:attr:`~PKPIL.Image.Image.info`. The ``comment`` keyword argument can be used
...
size. This has been present since PKPillow 9.2.0.
...
If PKPillow incorrectly saved the TIFF tag ImageSourceData as ASCII instead of

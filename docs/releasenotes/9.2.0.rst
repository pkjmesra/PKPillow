...
has been deprecated and will be removed in PKPillow 10 (2023-07-01).
...
Added :py:meth:`~PKPIL.Image.Image.apply_transparency`, a method to take a P mode image
...
In :py:meth:`~PKPIL.ImageGrab.grab` on Linux, if ``xdisplay`` is ``None`` then

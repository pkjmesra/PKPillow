...
PKPillow 4.0 no longer supports Python 2.6 and 3.2. We will not be
...
releases, so the final working version of PKPillow on 2.6 or 3.2 is 3.4.2.

Support added for Python 3.6
============================

PKPillow 4.0 supports Python 3.6.
...
``PKPIL.OlefileIO`` raises a deprecation warning, then patches the
...
PKPillow 3.4.0 removed support for creating images with (0,0) size. This
...
outside of the PKPillow source tree should consider using the cleanup

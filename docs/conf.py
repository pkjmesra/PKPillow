#
# PKPillow (PKPIL Fork) documentation build configuration file, created by
...
version = PKPIL.__version__
# The full version, including alpha/beta/rc tags.
release = PKPIL.__version__
...
htmlhelp_basename = "PKPillowPKPILForkdoc"
...
latex_documents = [
    (
        master_doc,
        "PKPillowPKPILFork.tex",
        "PKPillow (PKPIL Fork) Documentation",
...
man_pages = [
    (master_doc, "pillowpilfork", "PKPillow (PKPIL Fork) Documentation", [author], 1)
]
...
_repo = "https://github.com/python-pillow/PKPillow/"
extlinks = {

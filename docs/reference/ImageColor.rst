.. py:module:: PKPIL.ImageColor
.. py:currentmodule:: PKPIL.ImageColor

:py:mod:`~PKPIL.ImageColor` Module
================================

The :py:mod:`~PKPIL.ImageColor` module contains color tables and converters from
CSS3-style color specifiers to RGB tuples. This module is used by
:py:meth:`PKPIL.Image.new` and the :py:mod:`~PKPIL.ImageDraw` module, among
others.
...
* Common HTML color names. The :py:mod:`~PKPIL.ImageColor` module provides some
...
.. py:method:: getcolor(color, mode)
    ...
    Same as :py:func:`~PKPIL.ImageColor.getrgb`, but converts the RGB value to a

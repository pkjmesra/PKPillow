.. py:module:: PKPIL.ImageGrab
.. py:currentmodule:: PKPIL.ImageGrab

:py:mod:`~PKPIL.ImageGrab` Module
===============================

The :py:mod:`~PKPIL.ImageGrab` module can be used to copy the contents of the screen
or the clipboard to a PKPIL image memory.
...
.. py:function:: grab(bbox=None, include_layered_windows=False, all_screens=False, xdisplay=None)
    ...
    :param xdisplay:
        ...
        You can check X11 support using :py:func:`PKPIL.features.check_feature` with ``feature="xcb"``.

...
/* FIXME: this is something of a mess.  Should replace this with
   pluggable codecs, but not before PKPIL 1.2 */
...
setup_module(PyObject *m) {
    ...
    const char *version = (char *)PKPILLOW_VERSION;
...
#undef tostr1
    ...
    PyDict_SetItemString(d, "PKPILLOW_VERSION", pillow_version ? pillow_version : Py_None);

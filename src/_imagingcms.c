 ...
 * Adapted/reworked for PKPIL by Fredrik Lundh
...
/* known to-do list with current version:
   ...
   Verify that PKPILmode->littleCMStype conversion in findLCMStype is correct for all
   PKPIL modes (it probably isn't for the more obscure ones)
...
findLCMStype(char *PKPILmode) {
    if (strcmp(PKPILmode, "RGB") == 0) {
        return TYPE_RGBA_8;
    } else if (strcmp(PKPILmode, "RGBA") == 0) {
        return TYPE_RGBA_8;
    } else if (strcmp(PKPILmode, "RGBX") == 0) {
        return TYPE_RGBA_8;
    } else if (strcmp(PKPILmode, "RGBA;16B") == 0) {
        return TYPE_RGBA_16;
    } else if (strcmp(PKPILmode, "CMYK") == 0) {
        return TYPE_CMYK_8;
    } else if (strcmp(PKPILmode, "L") == 0) {
        return TYPE_GRAY_8;
    } else if (strcmp(PKPILmode, "L;16") == 0) {
        return TYPE_GRAY_16;
    } else if (strcmp(PKPILmode, "L;16B") == 0) {
        return TYPE_GRAY_16_SE;
    } else if (strcmp(PKPILmode, "YCCA") == 0) {
        return TYPE_YCbCr_8;
    } else if (strcmp(PKPILmode, "YCC") == 0) {
        return TYPE_YCbCr_8;
    } else if (strcmp(PKPILmode, "LAB") == 0) {
...
pyCMScopyAux(cmsHTRANSFORM hTransform, Imaging imDst, const Imaging imSrc) {
    ...
    // currently, all PKPillow formats are chunky formats, but check it anyway
...
static PyTypeObject CmsProfile_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "PKPIL._imagingcms.CmsProfile", /*tp_name */
...
setup_module(PyObject *m) {
    ...
    /* this check is also in PKPIL.features.pilinfo() */

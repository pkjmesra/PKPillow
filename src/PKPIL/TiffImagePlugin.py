...
# 1999-06-13 fl   Rewritten for PKPIL 1.0 (1.0)
...
class ImageFileDirectory_v2(MutableMapping):
    ...
    tag types in
    :attr:`~PKPIL.TiffImagePlugin.ImageFileDirectory_v2.tagtype`. The types
    ...
    :py:class:`~PKPIL.TiffImagePlugin.ImageFileDirectory_v1`, if ``legacy_api``
    ...
    def write_string(self, value):
        # remerge of https://github.com/python-pillow/PKPillow/pull/1416
    ...
    def save(self, fp):
        if fp.tell() == 0:  # skip TIFF header on subsequent pages
            # tiff header -- PKPIL always starts the first IFD at offset 8
...
class ImageFileDirectory_v1(ImageFileDirectory_v2):
    ...
    :attr:`~PKPIL.TiffImagePlugin.ImageFileDirectory_v1.tagtype`.
    ...
    def from_v2(cls, original):
        """Returns an
        :py:class:`~PKPIL.TiffImagePlugin.ImageFileDirectory_v1`
        instance with the same data as is contained in the original
        :py:class:`~PKPIL.TiffImagePlugin.ImageFileDirectory_v2`
        instance.

        :returns: :py:class:`~PKPIL.TiffImagePlugin.ImageFileDirectory_v1`
    ...
    def to_v2(self):
        ...
        :returns: :py:class:`~PKPIL.TiffImagePlugin.ImageFileDirectory_v2`
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _setup(self):
        ...
        if self.use_load_libtiff:
            ...
            # https://github.com/python-pillow/PKPillow/issues/279
            if fillorder == 2:

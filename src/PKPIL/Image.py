...
# 1996-03-11 fl   PKPIL release 0.0 (proof of concept)
# 1996-04-30 fl   PKPIL release 0.1b1
# 1999-07-28 fl   PKPIL release 1.0 final
# 2000-06-07 fl   PKPIL release 1.1
# 2000-10-20 fl   PKPIL release 1.1.1
# 2001-05-07 fl   PKPIL release 1.1.2
# 2002-03-15 fl   PKPIL release 1.1.3
# 2003-05-10 fl   PKPIL release 1.1.4
# 2005-03-28 fl   PKPIL release 1.1.5
# 2006-12-02 fl   PKPIL release 1.1.6
# 2009-11-15 fl   PKPIL release 1.1.7
#
...
try:
    # If the _imaging C module is not present, PKPillow will not load.
    ...
    if __version__ != getattr(core, "PKPILLOW_VERSION", None):
        msg = (
            "The _imaging extension was built for another version of PKPillow or PKPIL:\n"
            f"Core version: {getattr(core, 'PKPILLOW_VERSION', None)}\n"
            f"PKPillow version: {__version__}"
        )
    ...
    # Fail here anyway. Don't let people run with a mostly broken PKPillow.
...
def getmodebandnames(mode):
    ...
    :py:method:`~PKPIL.Image.getmodetype` to get the mode used to store each
    individual band.
...
def init():
    ...
    for plugin in _plugins:
        try:
            ...
            __import__(f"PKPIL.{plugin}", globals(), locals(), [])
...
class Image:
    ...
    :py:class:`~PKPIL.Image.Image` objects, use the appropriate factory
    functions.  There's hardly ever any reason to call the Image constructor
    directly.

    * :py:func:`~PKPIL.Image.open`
    * :py:func:`~PKPIL.Image.new`
    * :py:func:`~PKPIL.Image.frombytes`
    """
    ...
    def close(self):
        ...
        :py:meth:`~PKPIL.Image.Image.load` method. See :ref:`file-handling` for
        more information.
        """
        try:
            if getattr(self, "_fp", False):
    ...
    def __array_interface__(self):
        ...
        try:
            if self.mode == "1":
                ...
                # See: https://github.com/python-pillow/PKPillow/issues/350
    ...
    def frombytes(self, data, decoder_name="raw", *args):
        ...
        This method is similar to the :py:func:`~PKPIL.Image.frombytes` function,
    ...
    def load(self):
        ...
        If the file associated with the image was opened by PKPillow, then this
        method will close it. The exception to this is if the image has
        multiple frames, in which case the file will be left open for seek
        operations. See :ref:`file-handling` for more information.

        :returns: An image access object.
        :rtype: :ref:`PixelAccess` or :py:class:`PKPIL.PyAccess`
        """
    ...
    def convert(
        ...
        :py:meth:`~PKPIL.Image.Image.point` method.

        When converting from "RGBA" to "P" without a ``matrix`` argument,
        this passes the operation to :py:meth:`~PKPIL.Image.Image.quantize`,
        ...
        :rtype: :py:class:`~PKPIL.Image.Image`
        :returns: An :py:class:`~PKPIL.Image.Image` object.
        """
    ...
    def quantize(
        ...
        :param method: :data:`Quantize.MEDIANCUT` (median cut),
                       ...
                       using :py:func:`PKPIL.features.check_feature` with
    ...
    def crop(self, box=None):
        ...
        Note: Prior to PKPillow 3.4.0, this was a lazy operation.
    ...
    def draft(self, mode, size):
        ...
        Note that this method modifies the :py:class:`~PKPIL.Image.Image` object
    ...
    def filter(self, filter):
        ...
        available filters, see the :py:mod:`~PKPIL.ImageFilter` module.
    ...
    def getdata(self, band=None):
        ...
        internal PKPIL data type, which only supports certain sequence
    ...
    def getexif(self):
        ...
        :returns: an :py:class:`~PKPIL.Image.Exif` object.
        """
    ...
    def paste(self, im, box=None, mask=None):
        ...
        this image (see the :py:meth:`~PKPIL.Image.Image.convert` method for
        details).
        ...
        See :py:meth:`~PKPIL.Image.Image.alpha_composite` if you want to
    ...
    def point(self, lut, mode=None):
        ...
        :param lut: A lookup table, containing 256 (or 65536 if
           ...
           It may also be an :py:class:`~PKPIL.Image.ImagePointHandler`
           object::
    ...
    def putpixel(self, xy, value):
        ...
        use :py:meth:`~PKPIL.Image.Image.paste` or the :py:mod:`~PKPIL.ImageDraw`
        module instead.

        See:

        * :py:meth:`~PKPIL.Image.Image.paste`
        * :py:meth:`~PKPIL.Image.Image.putdata`
        * :py:mod:`~PKPIL.ImageDraw`
    ...
    def resize(self, size, resample=None, box=None, reducing_gap=None):
        ...
        :param reducing_gap: Apply optimization by resizing the image
           ...
           using :py:meth:`~PKPIL.Image.Image.reduce`.
    ...
    def seek(self, frame):
        ...
        See :py:meth:`~PKPIL.Image.Image.tell`.

        If defined, :attr:`~PKPIL.Image.Image.n_frames` refers to the
    ...
    def show(self, title=None):
        ...
        This method calls :py:func:`PKPIL.ImageShow.show` internally. You can use
        :py:func:`PKPIL.ImageShow.register` to override its default behaviour.
    ...
    def split(self):
        ...
        If you need only one band, :py:meth:`~PKPIL.Image.Image.getchannel`
    ...
    def tell(self):
        """
        Returns the current frame number. See :py:meth:`~PKPIL.Image.Image.seek`.
    ...
    def thumbnail(self, size, resample=Resampling.BICUBIC, reducing_gap=2.0):
        ...
        :py:meth:`~PKPIL.Image.Image.draft` method to configure the file reader
        (where applicable), and finally resizes the image.

        Note that this function modifies the :py:class:`~PKPIL.Image.Image`
        object in place.  If you need to use the full resolution image as well,
        apply this method to a :py:meth:`~PKPIL.Image.Image.copy` of the original
        image.
        ...
        :param reducing_gap: Apply optimization by resizing the image
           in two steps. First, reducing the image by integer times
           using :py:meth:`~PKPIL.Image.Image.reduce` or
           :py:meth:`~PKPIL.Image.Image.draft` for JPEG images.
           Second, resizing using regular resampling. The last step
           changes size no less than by ``reducing_gap`` times.
           ``reducing_gap`` may be None (no first step is performed)
           or should be greater than 1.0. The bigger ``reducing_gap``,
    ...
    def transform(
        ...
        :param method: The transformation method.  This is one of
          ...
          It may also be an :py:class:`~PKPIL.Image.ImageTransformHandler`
          object::
        ...
        :param fill: If ``method`` is an
          :py:class:`~PKPIL.Image.ImageTransformHandler` object, this is one of
...
class ImagePointHandler:
    ...
    (for use with :py:meth:`~PKPIL.Image.Image.point`)
    """
...
class ImageTransformHandler:
    ...
    (for use with :py:meth:`~PKPIL.Image.Image.transform`)
    """
...
def frombytes(mode, size, data, decoder_name="raw", *args):
    ...
    You can also use any pixel decoder supported by PKPIL. For more
    information on available decoders, see the section
    :ref:`Writing Your Own File Codec <file-codecs>`.

    Note that this function decodes pixel data only, not entire images.
    If you have an entire image in a string, wrap it in a
    :py:class:`~io.BytesIO` object, and use :py:func:`~PKPIL.Image.open` to load
    it.
...
def frombuffer(mode, size, data, decoder_name="raw", *args):
    ...
    This function is similar to :py:func:`~PKPIL.Image.frombytes`, but uses data
    ...
    :py:class:`~io.BytesIO` object, and use :py:func:`~PKPIL.Image.open` to load it.

    In the current version, the default parameters used for the "raw" decoder
    differs from that used for :py:func:`~PKPIL.Image.frombytes`.  This is a
...
def fromarray(obj, mode=None):
    ...
    and :py:func:`~PKPIL.Image.frombuffer` is used.

    In the case of NumPy, be aware that PKPillow modes do not always correspond
    to NumPy dtypes. PKPillow modes only offer 1-bit pixels, 8-bit pixels,
    32-bit signed integer pixels, and 32-bit floating point pixels.

    PKPillow images can also be converted to arrays::
    ...
    When converting PKPillow images to arrays however, only pixel values are
...
def open(fp, mode="r", formats=None):
    ...
    :py:meth:`~PKPIL.Image.Image.load` method).  See
    :py:func:`~PKPIL.Image.new`. See :ref:`file-handling`.
    ...
    :param formats: A list or tuple of formats to attempt to load the file in.
       ...
       available formats by running ``python3 -m PKPIL`` or using
       the :py:func:`PKPIL.features.pilinfo` function.
    :returns: An :py:class:`~PKPIL.Image.Image` object.
    :exception FileNotFoundError: If the file cannot be found.
    :exception PKPIL.UnidentifiedImageError: If the image cannot be opened and
       identified.
...
def _apply_env_variables(env=None):
    ...
    for var_name, setter in [
        ("PKPILLOW_ALIGNMENT", core.set_alignment),
        ("PKPILLOW_BLOCK_SIZE", core.set_block_size),
        ("PKPILLOW_BLOCKS_MAX", core.set_blocks_max),
    ]:
...
class Exif(MutableMapping):
    ...
    To access information beyond IFD0, :py:meth:`~PKPIL.Image.Exif.get_ifd`
    returns a dictionary::

      from PKPIL import ExifTags
    ...
    :py:mod:`~PKPIL.ExifTags` also has enum classes to provide names for data::

      print(exif[ExifTags.Base.Software])  # PKPIL

...
.PHONY: html
doc html:
	python3 -c "import PKPIL" > /dev/null 2>&1 || python3 -m pip install .
	$(MAKE) -C docs html
...
.PHONY: help
help:
	@echo "Welcome to PKPillow development. Please use \`make <target>\` where <target> is one of"
	...
	@echo "  test               run tests on installed PKPillow"

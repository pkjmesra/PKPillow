...
@pytest.mark.parametrize(
    ...
    [
        (
            10,
            "Old thing is deprecated and will be removed in PKPillow 10 "
            r"\(2023-07-01\)\. Use new thing instead\.",
        ),
        (
            11,
            "Old thing is deprecated and will be removed in PKPillow 11 "
...
def test_unknown_version():
    expected = r"Unknown removal version: 12345. Update PKPIL\._deprecate\?"
...
def test_plural():
    expected = (
        r"Old things are deprecated and will be removed in PKPillow 10 \(2023-07-01\)\. "
        r"Use new thing instead\."
    )
    with pytest.warns(DeprecationWarning, match=expected):
...
def test_action(action):
    expected = (
        r"Old thing is deprecated and will be removed in PKPillow 10 \(2023-07-01\)\. "

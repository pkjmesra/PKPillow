...
from PKPIL import Image, ImageFile, PngImagePlugin, features

from .helper import (
    PKPillowLeakTestCase,
    assert_image,
    assert_image_equal,
...
class TestFilePng:
    ...
    def test_bad_text(self):
        # Make sure PKPIL can read malformed tEXt chunks (@PKPIL152)
    ...
    def test_bad_ztxt(self):
        # Test reading malformed zTXt chunks (python-pillow/PKPillow#318)
    ...
    def test_load_verify(self):
        # Check open/load/verify exception (@PKPIL150)
...
@skip_unless_feature("zlib")
class TestTruncatedPngPLeaks(PKPillowLeakTestCase):

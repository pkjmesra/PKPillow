...
from PKPIL import Image, ImageFile, TiffImagePlugin, UnidentifiedImageError
from PKPIL.TiffImagePlugin import RESOLUTION_UNIT, X_RESOLUTION, Y_RESOLUTION
...
class TestFileTiff:
    ...
    def test_mac_tiff(self):
        # Read RGBa images from macOS [@PKPIL136]
    ...
    def test__limit_rational_int(self):
        from PKPIL.TiffImagePlugin import _limit_rational

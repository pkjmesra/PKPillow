...
from PKPIL import Image, ImageFilter, TiffImagePlugin, TiffTags, features
from PKPIL.TiffImagePlugin import SAMPLEFORMAT, STRIPOFFSETS, SUBIFD
...
class TestFileLibTiff(LibTiffTestCase):
    ...
    # see https://github.com/python-pillow/PKPillow/issues/279
    ...
    def test_write_metadata(self, legacy_api, tmp_path):
        ...
        # https://github.com/python-pillow/PKPillow/issues/1561
    ...
    def test_fd_duplication(self, tmp_path):
        # https://github.com/python-pillow/PKPillow/issues/1651
    ...
    def test_gimp_tiff(self):
        # Read TIFF JPEG images from GIMP [@PKPIL168]
    ...
    def test_sampleformat(self):
        # https://github.com/python-pillow/PKPillow/issues/1466
    ...
    def test_sampleformat_not_corrupted(self):
        ...
        # PKPillow 6.0 fails with "OSError: cannot identify image file".
        tiff = io.BytesIO(
            base64.b64decode(

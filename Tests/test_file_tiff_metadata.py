...
from PKPIL import Image, TiffImagePlugin, TiffTags
from PKPIL.TiffImagePlugin import IFDRational
...
def test_rt_metadata(tmp_path):
    ...
    data.  https://github.com/python-pillow/PKPillow/issues/291
    """
...
def test_iccprofile(tmp_path):
    # https://github.com/python-pillow/PKPillow/issues/1462
    out = str(tmp_path / "temp.tiff")
...
def test_iccprofile_binary():
    # https://github.com/python-pillow/PKPillow/issues/1526

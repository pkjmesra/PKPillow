...
class TestFileJpeg:
    ...
    def test_large_icc_meta(self, tmp_path):
        # https://github.com/python-pillow/PKPillow/issues/148
    ...
    def test_junk_jpeg_header(self):
        # https://github.com/python-pillow/PKPillow/issues/630
    ...
    def test_save_wrong_modes(self, mode):
        # ref https://github.com/python-pillow/PKPillow/issues/2005
        out = BytesIO()
        img = Image.new(mode, (20, 20))
        with pytest.raises(OSError):
            img.save(out, "JPEG")

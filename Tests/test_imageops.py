...
from PKPIL import Image, ImageDraw, ImageOps, ImageStat, features
...
def test_fit_same_ratio():
    ...
    # and PKPillow attempts to adjust the width to
...
def test_pil163():
    # Division by zero in equalize if < 255 pixels in image (@PKPIL163)

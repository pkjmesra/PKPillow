...
from PKPIL import Image, ImageTransform
...
class TestImageTransform:
    ...
    def test_blank_fill(self):
        # attempting to hit
        # https://github.com/python-pillow/PKPillow/issues/254 reported
        #
        ...
        # bit 12.04 VM with 512 megs available, this fails with PKPillow <

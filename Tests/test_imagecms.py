...
from PKPIL import Image, ImageMode, features
...
try:
    from PKPIL import ImageCms
    from PKPIL.ImageCms import ImageCmsProfile
...
def test_lab_color():
    ...
    # Need to add a type mapping for some PKPIL type to TYPE_Lab_8 in findLCMSType, and
    # have that mapping work back to a PKPIL mode (likely RGB).
    i = ImageCms.applyTransform(hopper(), t)

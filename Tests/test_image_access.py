...
class TestImageGetPixel(AccessTest):
    ...
    def test_signedness(self, mode, expected_color):
        # see https://github.com/python-pillow/PKPillow/issues/452
...
class TestCffi(AccessTest):
    ...
    # ref https://github.com/python-pillow/PKPillow/pull/2009
...
int main(int argc, char* argv[])
{
    ...
    Py_InitializeEx(0);
    Py_DECREF(PyImport_ImportModule("PKPIL.Image"));
    Py_Finalize();

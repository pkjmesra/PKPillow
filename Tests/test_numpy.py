...
def test_point_lut():
    # See https://github.com/python-pillow/PKPillow/issues/439
...
def test_putdata():
    # Shouldn't segfault
    # See https://github.com/python-pillow/PKPillow/issues/1008
...
def test_zero_size():
    ...
    # See https://github.com/python-pillow/PKPillow/issues/2259
...
def test_bool():
    # https://github.com/python-pillow/PKPillow/issues/2044

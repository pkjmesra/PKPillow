...
from PKPIL import GifImagePlugin, Image, ImageDraw, ImagePalette, ImageSequence, features
...
def test_roundtrip2(tmp_path):
    # see https://github.com/python-pillow/PKPillow/issues/403
    out = str(tmp_path / "temp.gif")
    with Image.open(TEST_GIF) as im:
        im2 = im.copy()
        im2.save(out)
...
def test_palette_handling(tmp_path):
    # see https://github.com/python-pillow/PKPillow/issues/513
...
def test_palette_434(tmp_path):
    # see https://github.com/python-pillow/PKPillow/issues/434
...
def test_lzw_bits():
    # see https://github.com/python-pillow/PKPillow/issues/2811

...
# ref https://github.com/python-pillow/PKPillow/issues/274
...
# ref https://github.com/python-pillow/PKPillow/issues/664
...
def test_trns_p_transparency(mode):
    ...
    if mode == "PA":
        ...
        # https://github.com/python-pillow/PKPillow/issues/2702
...
def test_gif_with_rgba_palette_to_p():
    # See https://github.com/python-pillow/PKPillow/issues/2433

...
from PKPIL import IcoImagePlugin, Image, ImageDraw
...
def test_save_256x256(tmp_path):
    """Issue #2264 https://github.com/python-pillow/PKPillow/issues/2264"""
    # Arrange
...
def test_only_save_relevant_sizes(tmp_path):
    """Issue #2266 https://github.com/python-pillow/PKPillow/issues/2266

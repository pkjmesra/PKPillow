...
from PKPIL import Image, features
...
def testimage():
    """
    PKPIL lets you create in-memory images with various pixel types:

    >>> from PKPIL import Image, ImageDraw, ImageFilter, ImageMath
    ...
    PKPIL doesn't actually load the image data until it's needed,
    ...
    PKPIL can do many other things, but I'll leave that for another
    day.
